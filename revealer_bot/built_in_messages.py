simple_reply_defaults = [
    ("vegetables", "I like vegetables"),
    ("nft", "Once 10 ETH have been contributed the album will be released and anyone can listen to the album."),
    ...
    ("3 ETH", "Once 3 ETH have been contributed, 3 songs will be release."),
    ("released", "The album is released and open to all once 10 ETH have been contributed."),
]